...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_rlp_encode, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, tx_data, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_secp256k1_sign, 0, 2, IS_ARRAY, 0)
...
const zend_function_entry waves_functions[] = {
    ...
    PHP_FE(rlp_encode, arginfo_rlp_encode)
